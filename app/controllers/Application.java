...
public class Application extends Controller {
	...
	private static Finder<String, Aluno> usuariosLogados = new Finder<String, Aluno>(
	...
	public static Result index() {
		...
		return ok(views.html.index.render(
				usuariosLogados.byId(session("email")), disciplinaForm,
				grid.getPlanejador()));
	}
	...
	public static Result matriculaNaDisciplina(int periodo, String disciplina) {
		...
		if (filledForm.hasErrors()) {
			...
			grid.getPlanejador().alteraPeriodoDaDisciplina(
					usuariosLogados.byId(session("email")),
	...
	public static Result removeDisciplina(String nomeDaDisciplina) {
		Disciplina disciplina = grid.getPlanejador().getDisciplina(
				nomeDaDisciplina);
		...
		grid.getPlanejador().removeDisciplinaESeusPreRequisitos(
				usuariosLogados.byId(session("email")), disciplina);
	...
	public static Result criarUsuario() {
		...
		if (usuariosLogados.byId(novoAluno.getEmail()) != null) {
			flash("success",
					"Usuário já existente no sistema, utilize outro e-mail");
			return cadastrarNovoUsuario();
		}
	...
	public static Result authenticate() {
		...
		if (loginForm.hasErrors()) {
			...
			if (usuariosLogados.byId(loginForm.get().getEmail()) == null) {
				...
				if (!usuariosLogados.byId(loginForm.get().getEmail())
