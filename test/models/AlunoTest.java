...
public class AlunoTest {
	...
	public void userStoriesTest() throws AlunoNaoPossuiPreRequisitosException {
		...
		aluno.getPlanoDoAluno().addPeriodo(new Periodo(new ArrayList<Disciplina>(), 2));
		aluno.getPlanoDoAluno().addPeriodo(new Periodo(new ArrayList<Disciplina>(), TERCEIRO_PERIODO));
