...
alter table periodo add constraint fk_periodo_aluno_2 foreign key (aluno_id) references aluno (id) on delete restrict on update restrict;
create index ix_periodo_aluno_2 on periodo (aluno_id);
